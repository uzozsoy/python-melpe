...
It's only tested on Windows and Ubuntu, and achieves near-identical results on PESQ 
and ESTOI compared to the 1200bps clip from the official Compandent MELPe website.
